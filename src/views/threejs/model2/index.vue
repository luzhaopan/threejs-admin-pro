<template>
  <div class="css3d_m" id="css3d_m"></div>
</template>
...
function init() {
  camera = new THREE.PerspectiveCamera(70, c_width / c_height, 1, 5000)
  ...
  document.getElementById('css3d_m').appendChild(renderer.domElement)
